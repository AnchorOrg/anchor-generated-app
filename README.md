...
Before running Cypress tests, specify Auth0 user credentials by overriding the `CYPRESS_E2E_USERNAME` and
`CYPRESS_E2E_PASSWORD` environment variables.
...
To build the final jar and optimize the anchorApp application for production, run:
