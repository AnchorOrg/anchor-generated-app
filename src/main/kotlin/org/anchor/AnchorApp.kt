...
import org.anchor.config.ApplicationProperties
import org.anchor.config.CRLFLogConverter
...
class AnchorApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes anchorApp.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<AnchorApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(AnchorApp::class.java)
