...
class AuthorizationHeaderUtil(
        ...
        if (authentication is OAuth2AuthenticationToken) {
            ...
            if (accessToken != null) {
                ...
                if (isExpired(accessToken)) {
                    ...
                    accessTokenValue = refreshToken(client, authentication)
            ...
            val authorizationHeaderValue =
                java.lang.String.format("%s %s", OAuth2AccessToken.TokenType.BEARER.value, tokenValue)
            return Optional.of(authorizationHeaderValue)
        }
    ...
    private fun refreshTokenClient(currentClient: OAuth2AuthorizedClient): OAuth2AccessTokenResponse? {
        ...
        try {
            val r =
                restTemplate(currentClient.clientRegistration.clientId, currentClient.clientRegistration.clientSecret)
